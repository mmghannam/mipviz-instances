...
**3,072 vertices and 4,607 edges** (maximum degree 3). The optimal
...
file
([`chromaticindex256-8.sol.gz`](https://miplib.zib.de/downloads/solutions/chromaticindex256-8/1/chromaticindex256-8.sol.gz)).
