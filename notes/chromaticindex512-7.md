...
**6,144 vertices and 9,215 edges** (maximum degree 3). The optimal
...
file
([`chromaticindex512-7.sol.gz`](https://miplib.zib.de/downloads/solutions/chromaticindex512-7/1/chromaticindex512-7.sol.gz)).
